#modified as segformer_mitlocal's data.py
import os
...
class SegFolder(Dataset):
    ...
    def __getitem__(self, idx: int):
        base = os.path.splitext(self.imgs[idx])[0].split('/')[-1] #file name part, no dir and ext
        ...
        return {'image': img_t, 'mask': mask_t, 'name': base}
        #return img_t, mask_t
